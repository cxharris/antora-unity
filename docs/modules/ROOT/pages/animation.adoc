...
. Repeat the above steps to download a _walking_ animation and a _running_ animation. 
 ...
 [IMPORTANT]
 ====
 For animations that include movement over the ground - like walking and running - you should check the *In Place* checkbox before downloading - otherwise the characters will move across the scene when you activate them within Unity.
 ====
