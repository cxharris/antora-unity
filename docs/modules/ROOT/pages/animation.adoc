...
+
** _Meshes_: Alpha_Joints and Alpha_Surface - both skinned and unskinned versions. The skinned versions are a combination of their regular meshes, their materials and the rig. It is these two *skinned* meshes that Unity integrates to make a unfied model.
