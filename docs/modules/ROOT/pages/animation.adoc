...
. Click on *Alpha_Joints* in the expanded Hierarchy view of *ybot@walking* and drag its material - *Alpha_Joints_MAT* onto the plane in your scene window - a small aesthetic change that improves the colour balance of the scene. 
...
. Click on the *ybot@Walking* item in the Hierarchy panel and then *Add Component* in the Inspector. Search for *Animator* and select it - this adds an *Animator* component to our GameObject.

. Create an *Animations* folder underneath *Assets*, and double-click to open it.

. Right click in the currently empty *Animations* folder, choose *Animator Controller* and rename it to *YBotController*. 

. Drag *YBotController* into the currently empty *Controller* slot of the *Animator* component we just added to *ybot@Walking*.
+
