...
+
Press *DOWNLOAD* to download the walking animation to a known directory on your machine.

. Repeat the above steps to download a _walking_ animation and a _running_ animation. Note that for animations that include movement over the ground - like walking and running - you should check the *In Place* checkbox before downloading:
+ 
[#img-walking-ybot]
